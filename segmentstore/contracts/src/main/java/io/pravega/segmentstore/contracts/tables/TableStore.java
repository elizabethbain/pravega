 ...
 * updates.
 * * If at least one of the {@link TableEntry} instances in the put() call has {@link TableEntry#key} {@link TableKey#version} true,
...
public interface TableStore {
     ...
     * @param entries     A List of {@link TableEntry} instances to insert or update. If {@link TableEntry#key} {@link TableKey#version}
     *                    returns true for at least one of the items in the list, then this will perform an atomic Conditional
     *                    Update. If {@link TableEntry#key} {@link TableKey#version} returns false for ALL items in the list, then this
     ...
     * <ul>
     * <li>{@link StreamSegmentNotExistsException} If the Table Segment does not exist.
     * <li>{@link TableKeyTooLongException} If {@link TableEntry#key} exceeds {@link #maximumKeyLength()}.
     * <li>{@link TableValueTooLongException} If {@link TableEntry#value} exceeds {@link #maximumValueLength()}.
     * <li>{@link ConditionalTableUpdateException} If {@link TableEntry#key} {@link TableKey#version}{@link TableEntry#key} {@link TableKey#version} is true and
     * {@link TableEntry#key} {@link TableKey#version} does not match the Table Entry's Key current Table Version.
     * <li>{@link BadSegmentTypeException} If segmentName refers to a non-Table Segment.
     * </ul>
     */
     ...
     * <li>{@link ConditionalTableUpdateException} If haVersion {@link TableKey#version} is true and {@link TableKey#version}
